...
**Project:** Financial Decision Studio
...
**Version covered by this notice:** 3.0.0 (engine 3.0.0, schema 2.1.0, build `FDS-DEFINITIVE-20260826`)

Rights not granted by the license in this repository — including commercial use — require separate authorization from the copyright holder. See [`COMMERCIAL.md`](COMMERCIAL.md).
